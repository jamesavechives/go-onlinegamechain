...
// Package les implements the Light Onlinegamechain Subprotocol.
package les
...
import (
	...
	rpc "github.com/onlinegamechain/go-onlinegamechain/rpc"
)

type LightOnlinegamechain struct {
	odr         *LesOdr
	relay       *LesTxRelay
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightOnlinegamechain, error) {
...
func (s *LightDummyAPI) OGCbase() (common.Address, error) {
...
func (s *LightOnlinegamechain) APIs() []rpc.API {
...
func (s *LightOnlinegamechain) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightOnlinegamechain) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightOnlinegamechain) TxPool() *light.TxPool              { return s.txPool }
func (s *LightOnlinegamechain) Engine() consensus.Engine           { return s.engine }
func (s *LightOnlinegamechain) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightOnlinegamechain) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightOnlinegamechain) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightOnlinegamechain) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// Onlinegamechain protocol implementation.
func (s *LightOnlinegamechain) Start(srvr *p2p.Server) error {
...
func (s *LightOnlinegamechain) Stop() error {
	s.odr.Stop()
