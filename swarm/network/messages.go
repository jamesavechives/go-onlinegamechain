...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/swarm/network/kademlia"
	"github.com/onlinegamechain/go-onlinegamechain/swarm/services/swap"
...
Timeout serves to indicate whogc the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whogc responder is expected to deliver content
