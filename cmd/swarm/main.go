...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/cmd/utils"
	"github.com/onlinegamechain/go-onlinegamechain/common"
	"github.com/onlinegamechain/go-onlinegamechain/console"
	"github.com/onlinegamechain/go-onlinegamechain/contracts/ens"
	"github.com/onlinegamechain/go-onlinegamechain/crypto"
	"github.com/onlinegamechain/go-onlinegamechain/ethclient"
	"github.com/onlinegamechain/go-onlinegamechain/internal/debug"
	...
	"github.com/onlinegamechain/go-onlinegamechain/swarm"
	bzzapi "github.com/onlinegamechain/go-onlinegamechain/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Onlinegamechain API provider to use to settle SWAP payments",
	...
	EnsAPIFlag = cli.StringFlag{
		Name:   "ens-api",
		Usage:  "URL of the Onlinegamechain API provider to use for ENS record lookups",
...
var app = utils.NewApp(gitCommit, "Onlinegamechain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-onlinegamechain Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.onlinegamechain/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.onlinegamechain/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.onlinegamechain/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.onlinegamechain/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//setup the onlinegamechain node
	...
	//register BZZ as node.Service in the onlinegamechain node
...
func registerBzzService(bzzconfig *bzzapi.Config, ctx *cli.Context, stack *node.Node) {
	...
	//register within the onlinegamechain node
