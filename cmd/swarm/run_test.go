...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/internal/cmdtest"
...
// as flags).
//
// When starting more than one node, they are connected togogc using the
