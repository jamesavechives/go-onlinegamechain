...
type wizard struct {
	...
	services map[string][]string   // Onlinegamechain services known to be running on servers
...
// it to an Onlinegamechain address.
...
// converts it to an Onlinegamechain address. If an empty line is entered, the default
// value is returned.
