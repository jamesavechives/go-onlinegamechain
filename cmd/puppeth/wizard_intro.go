...
// setting up a new or managing an existing Onlinegamechain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Onlinegamechain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Onlinegamechain network down to  |")
	...
	log.Info("Administering Onlinegamechain network", "name", w.network)
