...
RUN \
	sed -i 's/PuppethNetworkID/{{.NetworkID}}/g' dist/js/ogcwallet-master.js && \
	sed -i 's/PuppethNetwork/{{.Network}}/g'     dist/js/ogcwallet-master.js && \
	sed -i 's/PuppethDenom/{{.Denom}}/g'         dist/js/ogcwallet-master.js && \
	sed -i 's/PuppethHost/{{.Host}}/g'           dist/js/ogcwallet-master.js && \
	sed -i 's/PuppethRPCPort/{{.RPCPort}}/g'     dist/js/ogcwallet-master.js
...
// checkWallet does a health-check against web wallet server to verify whogc
// it's running, and if yes, whogc it's responsive.
