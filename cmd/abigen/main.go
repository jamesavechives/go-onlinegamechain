...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Onlinegamechain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Onlinegamechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Onlinegamechain contract Solidity source to build and bind")
