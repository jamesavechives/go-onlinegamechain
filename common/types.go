...
// Address represents the 20 byte address of an Onlinegamechain account.
...
// IsHexAddress verifies whogc a string can represent a valid hex-encoded
// Onlinegamechain address or not.
