...
// DefaultConfig contains default settings for use on the Onlinegamechain main net.
...
type Config struct {
	...
	// If nil, the Onlinegamechain main net block is used.
	...
	OGCbase    common.Address `toml:",omitempty"`
