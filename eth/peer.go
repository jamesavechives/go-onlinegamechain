...
// PeerInfo represents a short summary of the Onlinegamechain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Onlinegamechain protocol version negotiated
...
// the Onlinegamechain sub-protocol.
type peerSet struct {
