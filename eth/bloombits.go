...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Onlinegamechain
...
func (eth *Onlinegamechain) startBloomHandlers() {
...
// for the Onlinegamechain header bloom filters, permitting blazing fast filtering.
