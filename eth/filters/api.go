...
// information related to the Onlinegamechain protocol such als blocks, transactions and logs.
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(onlinegamechain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of onlinegamechain.FilterQuery.
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(onlinegamechain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/onlinegamechain/wiki/wiki/JSON-RPC#eth_getfilterchanges
