...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/eth/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in go-onlinegamechain.
func init() {
