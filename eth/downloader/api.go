...
// Syncing provides information when this nodes starts synchronising with the Onlinegamechain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  onlinegamechain.SyncProgress `json:"status"`
}
