...
// stateReq represents a batch of state fetch requests groupped togogc into
...
type stateReq struct {
	...
	dropped  bool                       // Flag whogc the peer dropped off early
}
...
// peer into the state trie, returning whogc anything useful was written or any
// error occurred.
