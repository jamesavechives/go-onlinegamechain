...
// Contains all the wrappers from the go-onlinegamechain root package.
...
type Subscription struct {
	sub onlinegamechain.Subscription
}
...
// the Onlinegamechain network.
type SyncProgress struct {
	progress onlinegamechain.SyncProgress
}
...
type FilterQuery struct {
	query onlinegamechain.FilterQuery
}
