...
// Contains a wrapper for the Onlinegamechain client.
...
// OnlinegamechainClient provides access to the Onlinegamechain APIs.
type OnlinegamechainClient struct {
	client *ethclient.Client
}

// NewOnlinegamechainClient connects a client to the given URL.
func NewOnlinegamechainClient(rawurl string) (client *OnlinegamechainClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &OnlinegamechainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *OnlinegamechainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *OnlinegamechainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *OnlinegamechainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *OnlinegamechainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *OnlinegamechainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *OnlinegamechainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *OnlinegamechainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *OnlinegamechainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *OnlinegamechainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *OnlinegamechainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *OnlinegamechainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *OnlinegamechainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *OnlinegamechainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *OnlinegamechainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *OnlinegamechainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *OnlinegamechainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *OnlinegamechainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *OnlinegamechainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *OnlinegamechainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *OnlinegamechainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *OnlinegamechainClient) SendTransaction(ctx *Context, tx *Transaction) error {
