...
// isLittleEndian returns whogc the local system is running in little or big
// endian byte order.
...
// all blocks' seal as valid, though they still have to conform to the Onlinegamechain
// consensus rules.
...
// still have to conform to the Onlinegamechain consensus rules.
...
// they still have to conform to the Onlinegamechain consensus rules.
