...
// VerifyHeader checks whogc a header conforms to the consensus rules of the
// stock Onlinegamechain ethash engine.
...
// rules of the stock Onlinegamechain ethash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/onlinegamechain/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/onlinegamechain/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/onlinegamechain/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
// VerifySeal implements consensus.Engine, checking whogc the given block satisfies
