...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/crypto/sha3"
...
// ecrecover extracts the Onlinegamechain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Onlinegamechain address
...
// Onlinegamechain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Onlinegamechain address of the signing key
...
// Author implements consensus.Engine, returning the Onlinegamechain address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks whogc a header conforms to the consensus rules.
...
// verifyHeader checks whogc a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whogc the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whogc the signature contained in the header satisfies the
