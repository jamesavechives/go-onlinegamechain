...
!define HELPURL "https://github.com/onlinegamechain/go-onlinegamechain/issues"
!define UPDATEURL "https://github.com/onlinegamechain/go-onlinegamechain/releases"
!define ABOUTURL "https://github.com/onlinegamechain/go-onlinegamechain#onlinegamechain-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Onlinegamechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Onlinegamechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Onlinegamechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/onlinegamechain/EIPs/issues/147)
