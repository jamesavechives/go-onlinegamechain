...
Please review the resulting diff to check whogc the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-onlinegamechain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-onlinegamechain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-onlinegamechain"
	}
	if startOfSentence {
		return "The go-onlinegamechain library"
	}
	return "the go-onlinegamechain library"
}
