...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Onlinegamechain blockchain to handle the consensus
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call onlinegamechain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call onlinegamechain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call onlinegamechain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call onlinegamechain.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query onlinegamechain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query onlinegamechain.FilterQuery, ch chan<- types.Log) (onlinegamechain.Subscription, error) {
