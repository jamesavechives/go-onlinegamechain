...
// Package bind generates Onlinegamechain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-onlinegamechain Wiki page:
// https://github.com/onlinegamechain/go-onlinegamechain/wiki/Native-DApps:-Go-bindings-to-Onlinegamechain-contracts
package bind
...
// structured checks whogc a list of ABI data types has enough information to
