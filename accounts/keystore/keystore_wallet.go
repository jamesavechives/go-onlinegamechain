...
// Status implements accounts.Wallet, returning whogc the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain onlinegamechain.ChainStateReader) {}
