...
// See https://github.com/onlinegamechain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whogc the event notification loop is running
...
// HasAddress reports whogc a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Onlinegamechain presale wallet and stores
