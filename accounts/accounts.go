...
// Package accounts implements high level Onlinegamechain account management.
package accounts
...
// Account represents an Onlinegamechain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Onlinegamechain account address derived from the key
...
type Wallet interface {
	...
	// Contains returns whogc an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain onlinegamechain.ChainStateReader)
