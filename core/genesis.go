...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whogc the genesis block is already written.
	if genesis != nil {
...
// DefaultGenesisBlock returns the Onlinegamechain main net genesis block.
...
func defaultMainPrealloc() GenesisAlloc {
	...
	ga[common.HexToAddress("0x7ea05A75a46ED507171Ce75E4b22BE0655e15Fa6")] = GenesisAccount{Balance: amount}
	return ga
}
