...
// Package types contains data types related to Onlinegamechain consensus.
package types
...
// Header represents a block header in the Onlinegamechain blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togogc.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Onlinegamechain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Onlinegamechain
...
// EncodeRLP serializes b into the Onlinegamechain RLP block format.
