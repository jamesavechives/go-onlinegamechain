...
// Package core implements the Onlinegamechain consensus protocol.
package core
...
// available in the database. It initialises the default Onlinegamechain Validator and
// Processor.
...
//
// The verify parameter can be used to fine tune whogc nonce verification
