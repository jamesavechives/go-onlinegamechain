...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/common/bitutil"
...
type Matcher struct {
	...
	running uint32 // Atomic flag whogc a session is live or not
}
...
// that address/topic, and binary AND-ing those vectors togogc.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togogc
				var orVector []byte
...
// the reuested retrieval queue to be serviced togogc with other sessions.
//
