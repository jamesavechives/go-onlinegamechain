...
// Package state provides a caching layer atop the Onlinegamechain state trie.
package state
...
// StateDBs within the onlinegamechain protocol are used to store anything
...
// Exist reports whogc the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whogc the state object is either non-existent
...
//
// Carrying over the balance ensures that OGC doesn't disappear.
