...
type Context struct {
	// CanTransfer returns whogc the account contains
	// sufficient ogc to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers ogc from one account to the other
...
// EVM is the Onlinegamechain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) onlinegamechain virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whogc the max code size has been exceeded
