...
type operation struct {
	...
	halts   bool // indicates whogc the operation should halt further execution
	jumps   bool // indicates whogc the program counter should not increment
	writes  bool // determines whogc this a state modifying operation
	valid   bool // indication whogc the retrieved operation is valid and known
	reverts bool // determines whogc the operation reverts state (implicitly halts)
	returns bool // determines whogc the operations sets the return data content
}
