...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/event/filter"
...
// Whisper represents a dark communication interface through the Onlinegamechain
...
// New creates a Whisper client ready to communicate through the Onlinegamechain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
