...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/logger"
	"github.com/onlinegamechain/go-onlinegamechain/p2p"
	"github.com/onlinegamechain/go-onlinegamechain/p2p/nat"
	"github.com/onlinegamechain/go-onlinegamechain/whisper"
)
...
func main() {
	...
	// Create an Onlinegamechain peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Onlinegamechain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Onlinegamechain peer: %v.\n", err)
		os.Exit(1)
	}
