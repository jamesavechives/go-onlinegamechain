...
// Package chequebook package wraps the 'chequebook' Onlinegamechain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in ogc; (auto)cashing cheques in ogc
// as well as (auto)depositing ogc to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/contracts/chequebook/contract"
	...
	"github.com/onlinegamechain/go-onlinegamechain/swarm/services/swap/swap"
)
...
// * depositing ogc to the chequebook
// * watching incoming ogc
...
// Cash cashes the cheque by sending an Onlinegamechain transaction.
