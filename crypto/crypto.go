...
// Creates an onlinegamechain address given the bytes and the nonce
...
// controls whogc the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whogc the signature values are valid with
