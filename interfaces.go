...
// Package onlinegamechain defines interfaces for interacting with Onlinegamechain.
package onlinegamechain
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whogc the transaction has been
