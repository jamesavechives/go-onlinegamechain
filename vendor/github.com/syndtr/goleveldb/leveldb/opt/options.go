...
type Options struct {
	...
	// ErrorIfExist defines whogc an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whogc an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whogc block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whogc to sync underlying writes from the OS buffer cache
