...
// SetCtrlCAborts sets whogc Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whogc line is auto-wrapped. The default is false (single line).
...
// whogc to retry the call to, or return the error returned by, readNext.
