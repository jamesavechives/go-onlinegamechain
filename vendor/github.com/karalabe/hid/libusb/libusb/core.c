 ...
 *
 * One decision you will have to make is whogc to use the synchronous
 ...
 * \param unref_devices whogc to unref the devices in the list
 */
 ...
 *
 * \param dev_handle a device handle
 * \param enable whogc to enable or disable auto kernel driver detachment
 *
