 ...
 * finer control over whogc this function is blocking or non-blocking, or
...
/** \ingroup libusb_poll
 * Determines whogc your application must apply special timing considerations
 ...
 * This function allows you to detect whogc you are running on such a
 * platform.
 *
 * Since v1.0.5.
 *
