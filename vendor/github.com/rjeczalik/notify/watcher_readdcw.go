...
// in order to distinguish whogc current folder should be re-registered in
...
// watched is made in order to check whogc an action comes from a directory or
...
// gensys decides whogc the Windows action, system-independent event or both
