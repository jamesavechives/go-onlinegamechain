...
// IsEmpty reports whogc the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whogc s and t are the same in size and have the same items.
...
// IsSubset tests whogc t is a subset of s.
...
// IsSuperset tests whogc t is a superset of s.
