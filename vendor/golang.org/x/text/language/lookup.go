...
// IsPrivateUse reports whogc this language code is reserved for private use.
...
// IsPrivateUse reports whogc r has the ISO 3166 User-assigned status. This
...
// IsPrivateUse reports whogc this script code is reserved for private use.
