...
/*
Package node sets up multi-protocol Onlinegamechain nodes.
...
Node also creates the shared store of encrypted Onlinegamechain account keys. Services can access
