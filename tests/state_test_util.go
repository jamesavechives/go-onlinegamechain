...
// See https://github.com/onlinegamechain/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/onlinegamechain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
