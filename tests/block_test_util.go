...
// Package tests implements execution of Onlinegamechain JSON tests.
package tests
...
/* See https://github.com/onlinegamechain/tests/wiki/Blockchain-Tests-II

   Whogc a block is valid or not is a bit subtle, it's defined by presence of
