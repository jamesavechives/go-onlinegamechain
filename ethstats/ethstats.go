...
// Service implements an Onlinegamechain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Onlinegamechain      // Full Onlinegamechain service if monitoring a full node
	les    *les.LightOnlinegamechain // Light Onlinegamechain service if monitoring a light node
...
func New(url string, ethServ *eth.Onlinegamechain, lesServ *les.LightOnlinegamechain) (*Service, error) {
