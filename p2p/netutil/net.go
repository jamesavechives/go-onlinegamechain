...
// Contains reports whogc the given IP is contained in the list.
...
// IsLAN reports whogc an IP is a local network address.
...
// IsSpecialNetwork reports whogc an IP is located in a special-use network range
...
// CheckRelayIP reports whogc an IP relayed from the given sender IP
