...
import (
	...
	"github.com/onlinegamechain/go-onlinegamechain/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togogc.
//
...
// Connect connects two nodes togogc by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whogc there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whogc or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whogc or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whogc both nodes are currently up
