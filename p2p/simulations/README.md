...
creating a collection of devp2p nodes, connecting them togogc to form a
...
* `Expect` - an expectation function which returns whogc or not a
...
As a concrete example, consider a simulated network of Onlinegamechain nodes. An
