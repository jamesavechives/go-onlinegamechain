...
var (
	MainnetGenesisHash = common.HexToHash("0x2e06fc88b0d9115a267e2d017fdc652218f8343a43514ea44d53c7c40d98b3df") // Mainnet genesis hash to enforce below configs on
...
var (
	...
	// and accepted by the Onlinegamechain core developers into the Ethash consensus.
	//
	...
	// and accepted by the Onlinegamechain core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whogc the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/onlinegamechain/EIPs/issues/150)
...
// IsHomestead returns whogc num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAO returns whogc num is either equal to the DAO fork block or greater.
...
// CheckCompatible checks whogc scheduled fork transitions have been imported
...
// isForked returns whogc a fork scheduled at block s is active at the given head block.
