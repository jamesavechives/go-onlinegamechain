...
const (
	GasLimitBoundDivisor uint64 = 1024    // The bound divisor of the gas limit, used in update calculations.
	MinGasLimit          uint64 = 0    // Minimum the gas limit may ever be.
	GenesisGasLimit      uint64 = 4712388 // Gas limit of the Genesis block.
	...
	CallStipend           uint64 = 0  // Free gas given at beginning of call.
...
var (
	...
	DurationLimit          = big.NewInt(13)     // The decision boundary on the blocktime duration used to determine whogc difficulty should go up or not.
)
